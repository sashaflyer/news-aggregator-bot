...
- Within each section, prefix each bullet with a category marker: 🔴 for major issues and breaking changes, 🟡 for significant developments, 🔵 for interesting but less urgent items.
